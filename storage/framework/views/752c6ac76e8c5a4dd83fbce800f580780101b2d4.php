...
<?php $__env->startSection('title','权限组首页'); ?>
        ...
        <div class="larry-personal">
            ...
            <div class="larry-personal-body clearfix">
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(url('admin/group/create')); ?>" style="color:white">
                ...
                <table class="layui-table larry-table-info">
                    ...
                    <?php foreach( $data as $group ): ?>
                        <tr>
                            ...
                            <td style="color:#1E9FFF"><?php echo e($group->group_name); ?></td>
                            <td><?php echo e($status[$group->status]); ?></td>
                            <td>

                                <?php /*<?php echo e(explode(',', $group->role_list)); ?>*/ ?>
...
//                                        dump($v);
                            ...
                            <td style="width: 600px"><?php echo e($group->group_desc); ?></td>
                            <td>
                                <div class="layui-btn-group">
                                    <a href="<?php echo e(url('admin/group').'/'.$group->id); ?>" class="layui-btn  layui-btn-small"
                                       data-alt="查看">
                                        <i class="layui-icon">&#xe60b;</i>
                                    </a>
                                    <a href="<?php echo e(url('admin/group').'/'.$group->id."/edit"); ?>"
                                       class="layui-btn  layui-btn-small" data-alt="修改">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a id="delete" data-id="<?php echo e($group->id); ?>" class="layui-btn  layui-btn-small"
                                       data-alt="删除">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                </div>
        ...
        layui.use(['jquery', 'layer'], function () {
            ...
            $('a#delete').on('click', function () {
                ...
                layer.confirm('确定要删除吗?', {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('/admin/group')); ?>' + '/' + id
                        , type: "POST"
