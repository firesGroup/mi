    ...
    <section class="larry-grid">
        <div class="larry-personal">
            ...
            <header class="larry-personal-tit">
                ...
                <?php /*<button class="layui-btn layui-btn-radius layui-btn-primary" id="refresh">*/ ?>

                    <?php /*<i class="layui-icon">&#x1002;</i> 刷新本页*/ ?>
                <?php /*</button>*/ ?>

                <button class="layui-btn layui-btn-radius layui-btn-primary" id="refresh">

                    <a href="<?php echo e(url('admin/friend/create')); ?>"><i class="layui-icon">&#xe654;</i>添加</a>
                </button>
            ...
            <table class="layui-table larry-table-info">
                ...
                <?php foreach($data as $v): ?>
                    <tr>
                        <td class="cid"><?php echo e($v->id); ?></td>
                        <td><?php echo e($v->link_name); ?></td>
                        <td><?php echo e($v->link_url); ?></td>
                        <td><?php echo e($v->link_logo); ?></td>
                        <td><?php echo e($v->order); ?></td>
                        <td class="td">
                            <form action="" class="layui-form">
                                <input type="checkbox" name="hide" lay-skin="switch" lay-text="开启|关闭" <?php echo e($v->hide===0?'checked':''); ?>>
                            </form>
                            </td>
                        <td>
                            <div class="layui-btn-group">
                                ...
                                <a href="<?php echo e(url('admin/friend').'/'.$v->id.'/edit'); ?>"
                                       class="layui-btn  layui-btn-small"
                                       data-alt="修改">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>

                                <a id="delete" data-id="<?php echo e($v->id); ?>" class="layui-btn  layui-btn-small" data-alt="删除">
                                    <i class="layui-icon">&#xe640;</i>
                                </a>
                            </div>
                        </td>
        ...
        layui.use(['jquery', 'layer','form'], function () {
            ...
            $('a#delete').on('click', function () {
                ...
                layer.confirm('确定要删除吗?', {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('/admin/friend')); ?>' + '/' + id
                        , type: "POST"
...
//            console.log(id);
                ...
                $.ajax({
                    url:"<?php echo e(url('admin/friendStatus')); ?>",
                    type:'get',
