    ...
    <div class="xm-product-box">
        <div class="nav-bar" id="J_headNav">
            <div class="container J_navSwitch">
                <h2 class="J_proName"><?php echo e($info->p_name); ?></h2>
                <div class="con">
                    <div class="right">
                        <a href="<?php echo e(url('/product/info/'.$info->id)); ?>">概述</a>
                        <span class="separator">|</span>
                        <a href="">用户评价</a>
                        <?php if( isset($is_btn) && $is_btn == true ): ?>
                        <span class="J_pro_nav_bar">
                            <a href="<?php echo e(url('/product/buy/'.$info->id)); ?>"  id="J_nav_buy_btn"  class="btn btn-small btn-primary">立即购买</a>
                        </span>
                        <?php endif; ?>
                    </div>
                </div>
