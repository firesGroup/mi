                    ...
                    <form class="layui-form" method="post" id="model">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="model_name" lay-verify="required" placeholder="请输入模型名称" autocomplete="off" class="layui-input" value="">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                ...
                                <a class="layui-btn layui-btn-primary" href="<?php echo e(url('/admin/product/model')); ?>">返回</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        layui.use( ['jquery','layer','form'], function(){
            ...
            form.on('submit(addModel)',function(data){
                ...
                $.ajax({
                    url:'<?php echo e(url('admin/product/model')); ?>',
                    type: 'POST',
                    data: data.field,
                    success:function(res){
                        ...
                        if( res == 0 ){
                            layer.msg('添加成功', {icon:6, time:1000, end:function(){
                                location.href= '<?php echo e(url('/admin/product/model')); ?>';
                            }});
                        }else{
