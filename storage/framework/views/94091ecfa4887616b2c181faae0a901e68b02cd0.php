                ...
                <div class="layui-tab" lay-filter="tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" method="post" action="<?php echo e(url('admin/advert/'.$data->id)); ?>">
                                    ...
                                    <div class="layui-form-item">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="advert_url" lay-verify="required"
                                                       ...
                                                       value="<?php echo e($data->advert_url); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="ad_location" lay-verify="required"
                                                       ...
                                                       value="<?php echo e($data->ad_location); ?>">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">广告位置</label>
                                            <div class="layui-input-block">
                                                <input type="radio" name="status" value="0"  <?php echo e($data->status==0?'checked':''); ?> title="开启">
                                                <input type="radio" name="status" value="1" <?php echo e($data->status==1?'checked':''); ?> title="禁用">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <textarea type="text" name="ad_desc" lay-verify="required"
                                                      ...
                                                      class="layui-input"><?php echo e($data->ad_desc); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="margin-left:15px">
                                            <label class="layui-form-label">上传广告图片</label>
                                            <input id="upload-input" type="text" class="layui-input layui-input-inline" name="advert_image" value="<?php echo e($data->advert_image); ?>" style="width:520px;height:38px;margin:0px" placeholder="输入图片地址或点击上传">
        ...
        layui.use( ['jquery','layer','form','upload'], function(){
            ...
            layui.upload({
                ...
                before: function (input) {
                    //上传前回调
                    $('input#createUpload').parent().append('<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"><input type="hidden" name="path" value="ad">');
