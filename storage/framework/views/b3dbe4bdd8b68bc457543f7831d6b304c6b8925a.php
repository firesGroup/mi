...
<div class="site-topbar">
    <div class="container">
        ...
        <div class="topbar-info" id="J_userInfo">
            <?php /*<?php echo e(dd(session('user_deta'))); ?>*/ ?>
            <?php if(session('user_deta') != null ): ?>
                <div class="topbar-info" id="J_userInfo">
                    <span class="user">
                        <a rel="nofollow" class="user-name" href="<?php echo e(url('user_detail')); ?>" target="_blank">
                            <span class="name" id="user"><?php echo e(session('user_deta')['nick_name']); ?></span>
                            <i class="iconfont"></i>
                        </a>
                        <ul id="hidden" class="user-menu" style="display: none;">
                            <li>
                            <a rel="nofollow" href="<?php echo e(url('user_detail')); ?>" target="_blank" data-stat-id="e0b9e1d1fa8052a2" onclick="_msq.push(['trackEvent', '79fe2eae924d2a2e-e0b9e1d1fa8052a2', '//my.mi.com/portal', 'pcpid', '']);">个人中心
                            </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a rel="nofollow" href="<?php echo e(url('login/exit')); ?>" data-stat-id="770a31519c713b11" onclick="">退出登录</a>
                            </li>
                        </ul>
                    </span>
            ...
            <?php else: ?>
                    ...
                    <span class="sep">|</span>
                    <a rel="nofollow" class="link" href="<?php echo e(url('reg')); ?>">注册</a>
                    <?php endif; ?>
    ...
    <script>
        ...
        layui.use(['jquery', 'layer'], function () {
            ...
            $('a#J_miniCartBtn').on('mouseover', function () {
                   ...
                   <?php /*$('div.loading').replaceWith("<ul class='cart-list'><li><div class='cart-item clearfix first'><a class='thumb' href=''><img src='<?php echo e(session(session('goods')['id'])); ?>'></a><a class='name' href=''><?php echo e(session('goods')['total']); ?></a><span class='price'><?php echo e(session('goods')['price']); ?></span><a class='btn-del J_delItem' href='javascript:;' data-isbigtap='false'><i class='iconfont'></i></a></div></li></ul><div class='cart-total clearfix'><span class='total'>共 <em><?php echo e(session('goods')['num']); ?></em>件商品<span class='price'><em><?php echo e(session('goods')['price']); ?></em>元</span></span><a class='btn btn-primary btn-cart' href='<?php echo e(url('cart')); ?>'>去购物车结算</a></div>");*/ ?>
