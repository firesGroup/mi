...
<?php $__env->startSection('title','轮播图首页'); ?>
        ...
        <div class="larry-personal">
            ...
            <div class="larry-personal-body clearfix">
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(url('admin/slideShow/create')); ?>" style="color:white">
                ...
                <table class="layui-table larry-table-info">
                    ...
                    <?php foreach( $data as $show ): ?>
                        <?php /*<?php echo e(dump($show->status)); ?>*/ ?>
                        <tr>
                            <td id="id"><?php echo e($show->id); ?></td>
                            <td style="color:#1E9FFF; width:28%"><img src="<?php echo e($show->images); ?>" width="400"></td>
                            <td style="width:28%"><?php echo e($show->url); ?></td>
                            <td style="width:15%">
                                <form class="layui-form"><input class="checkbox" type="checkbox" name="status" lay-skin="switch" lay-text="启用|禁用" <?php echo e($show->status === 0?'checked':''); ?>></form></td>
                            <td style="width:23%">
                                <div class="layui-btn-group">
                                    <a href="<?php echo e(url('admin/slideShow').'/'.$show->id."/edit"); ?>"
                                       class="layui-btn  layui-btn-small" data-alt="修改">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a id="delete" data-id="<?php echo e($show->id); ?>" class="layui-btn  layui-btn-small"
                                       data-alt="删除">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                </div>
...
<?php $__env->startSection('js'); ?>
    @parent
    <script type="text/javascript" src="<?php echo e(asset('/js/admin/base.js')); ?>"></script>
    <script>
        layui.use(['jquery', 'layer', 'form'], function () {
            ...
            $('a#delete').on('click', function () {
                ...
                layer.confirm('确定要删除吗?', {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('/admin/slideShow')); ?>' + '/' + id
                        , type: "POST"
