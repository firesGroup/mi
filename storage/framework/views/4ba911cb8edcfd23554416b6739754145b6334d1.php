                ...
                <div class="layui-tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" action="<?php echo e(url('admin/friend/'.$data->id)); ?>" method="post">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="link_name" required lay-verify="required"
                                                   ...
                                                   class="layui-input" value="<?php echo e($data->link_name); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="link_url" required lay-verify="required"
                                                   placeholder="" autocomplete="off"
                                                   class="layui-input" value="<?php echo e($data->link_url); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="order" required lay-verify="required"
                                                   placeholder="" autocomplete="off"
                                                   class="layui-input" value="<?php echo e($data->order); ?>">
                                        </div>
                                    </div>
        ...
        layui.use(['form','upload','jquery'],function() {
            ...
            layui.upload({
                ...
                before: function (input) {
                    <?php /*var data = {"id": "<?php echo e($data->id); ?>"};*/ ?>
