            ...
            <div class="larry-personal-body clearfix">
                ...
                <table class="layui-table larry-table-info">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($product->cid); ?></td>
                        <td><?php echo e($product->bid); ?></td>
                        ...
                        <td>
                            <div class="layui-btn-group">
                                <a href="<?php echo e(url('admin/product').'/'.$product->id); ?>" class="layui-btn  layui-btn-small" data-alt="查看">
                                    <i class="layui-icon" >&#xe60b;</i>
                                </a>
                                <a href="<?php echo e(url('admin/product').'/'.$product->id."/edit"); ?>" class="layui-btn  layui-btn-small" data-alt="修改">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>
                                <a id="delete" data-id="<?php echo e($product->id); ?>" class="layui-btn  layui-btn-small" data-alt="删除">
                                    <i class="layui-icon">&#xe640;</i>
                                </a>
                            </div>
                        </td>
