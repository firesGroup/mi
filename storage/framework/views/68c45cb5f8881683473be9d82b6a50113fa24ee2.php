...
<?php $__env->startSection('title','评价回复'); ?>
            ...
            <table style="width:1500px ;height: auto;">
                <tbody>
                        ...
                        <?php foreach($comment as $v): ?>
                            ...
                            <?php if($v->member_id == $id && $v->type == 0 ): ?>
                                <tr>
                        ...
                        "><span><?php echo e($v->content); ?></span></div>
                                    </div>
...
<?php endforeach; ?>
        ...
        <div style="background-color: white;text-align: left;width: auto;padding-left: 25px;padding-top: 100px;padding-right: 25px;">
            ...
            <form action="<?php echo e(url('admin/commentShow')); ?>" method="post">
                <?php echo e(csrf_field()); ?>

                <input type="hidden" name="id" value="<?php echo e($v->p_id); ?>">
    ...
    <script>
        ...
        layui.use(['jquery', 'layer'], function () {
            ...
            $('#button').on('click',function () {
                ...
                pid = $('#pid').text();
    //alert(pid);
                <?php /*var url ='<?php echo e(url('admin/commentShow')); ?>';*/ ?>
                <?php /*$.ajax({*/ ?>
                    <?php /*url: url,*/ ?>
                    <?php /*type: 'get',*/ ?>
                    <?php /*data: { 'pid': pid , '_token': '<?php echo e(csrf_token()); ?>'},*/ ?>
                    <?php /*success: function (data) {*/ ?>
                        <?php /*console.log(<?php echo e(csrf_token()); ?>);*/ ?>
                    <?php /*}*/ ?>
