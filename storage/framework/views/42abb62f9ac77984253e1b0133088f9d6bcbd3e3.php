...
<?php $__env->startSection('title','权限修改页'); ?>
                ...
                <div class="layui-tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" action="<?php echo e(url('admin/role/'.$data->id)); ?>" method="post">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="role_name" required lay-verify="required"
                                                   placeholder="<?php echo e($data->role_name); ?>" autocomplete="off"
                                                   class="layui-input" value="<?php echo e($data->role_name); ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="role" required lay-verify="required"
                                                   placeholder="<?php echo e($data->role); ?>" autocomplete="off"
                                                   class="layui-input" value="<?php echo e($data->role); ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item layui-form-text">
                                        <label class="layui-form-label">权限描述</label>
                                        <div class="layui-input-block">
                                            <textarea name="role_desc" class="layui-textarea" value=""><?php echo e($data->role_desc); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use(['form', 'jquery', 'layer'], function () {
            ...
            $('input[name=role_name]').blur(function () {
                ...
                var name = "<?php echo e($data->role_name); ?>";
...
//                    console.log(1);
                    ...
                    var url = "<?php echo e(url('admin/ajaxRoleName')); ?>";
                    ...
                    if (origin != roleName) {
                        ...
                        $.ajax({
                            ...
                            data: {'_token': '<?php echo e(csrf_token()); ?>', 'roleName': roleName},
...
//                    console.log(1);
                    ...
                    var url = "<?php echo e(url('admin/ajaxRole')); ?>";
                    ...
                    if (origin != role) {
                        ...
                        $.ajax({
                            ...
                            data: {'_token': '<?php echo e(csrf_token()); ?>', 'role': role},
