...
<?php $__env->startSection('title','商品属性管理-添加'); ?>
                    ...
                    <form class="layui-form" method="post" id="attr">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                ...
                                <a class="layui-btn layui-btn-primary" href="<?php echo e(url('/admin/product/attr')); ?>">返回</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        layui.use( ['jquery','layer','form'], function(){
            ...
            form.on('submit(addattr)',function(data){
                ...
                $.ajax({
                    url:'<?php echo e(url('admin/product/attr')); ?>',
                    type: 'POST',
                    data: data.field,
                    success:function(res){
                        ...
                        if( res == 0 ){
                            layer.msg('添加成功', {icon:6, time:1000, end:function(){
                                location.href= '<?php echo e(url('/admin/product/attr')); ?>';
                            }});
                        }else if( res == 1){
