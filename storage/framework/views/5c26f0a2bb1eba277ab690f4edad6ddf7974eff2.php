        ...
        <div class="larry-personal">
            ...
            <div class="larry-personal-body clearfix">
                <div class="btn-group">
                    ...
                    <a style="color:white" href="<?php echo e(url('admin/level/create')); ?>">
                ...
                <table class="layui-table larry-table-info">
                    ...
                    <?php foreach( $data as $level ): ?>
                        <tr>
                            ...
                            <td><?php echo e($level->discount); ?></td>
                            <td><?php echo e($level-> level_desc); ?></td>
                            <td>
                                <div class="layui-btn-group">
                                    <a href="<?php echo e(url('admin/level').'/'.$level->id."/edit"); ?>" class="layui-btn"
                                       data-alt="查看编辑">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a id="delete" data-id="<?php echo e($level->id); ?>" class="layui-btn" data-alt="删除">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                </div>
                            </td>
        ...
        layui.use(['jquery', 'layer'], function () {
            ...
            $('a#delete').on('click', function () {
                ...
                layer.confirm('确定要删除吗?', {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('/admin/level')); ?>' + '/' + id
                        , type: "POST"
