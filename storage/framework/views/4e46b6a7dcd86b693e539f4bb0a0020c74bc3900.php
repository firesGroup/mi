...
<?php $__env->startSection('title', '会员详情页'); ?>
<?php $__env->startSection('css'); ?>
    @parent
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/css/admin/jquery.Jcrop.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/plugin/bootstrap/css/bootstrap.css')); ?>">
        ...
        <div class="larry-personal">
            ...
            <div class="larry-personal-body clearfix">
                <div class="layui-form layui-form-pane">
                        <img src="<?php echo e($user_detail->avator); ?>" width="100" id="upload" class="img-circle">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width:300px">
                            <div class="layui-input">
                                <?php echo e($array[$user_detail->level_id]); ?>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width:300px">
                            <div class="layui-input">
                                <?php echo e($user_detail->birthday); ?>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width:300px">
                            <div class="layui-input">
                                <?php echo e($arr[$user_detail->sex]); ?>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <?php echo Form::open( [ 'url' => ['/admin/change'], 'method' => 'POST', 'onsubmit'=>'return checkCoords();','files' => true ] ); ?>
