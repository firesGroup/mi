                ...
                <div class="layui-tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" action="<?php echo e(url('admin/user')); ?>" method="POST">
                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <input type="hidden" name="add_time" value="<?php echo e(date('Y-m-d H:i:s', time())); ?>">
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">管理员名</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="username" required lay-verify="required"
                                                   placeholder="请输入名称" autocomplete="off"
                                                   class="layui-input" value="<?php echo e(old('username')); ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline" style="margin-left: 40px">
                                            <input type="password" id="pwd" name="password" required
                                                   lay-verify="required"
                                                   placeholder="请输入密码" autocomplete="off" class="layui-input" value="<?php echo e(old('password')); ?>">
                                        </div>
...
//                console.log(that);
                ...
                var url = "<?php echo e(url('admin/ajax')); ?>";
