...
<?php $__env->startSection('title','商品品牌管理首页'); ?>
                ...
                <table class="layui-table larry-table-info">
                    ...
                    <?php foreach( $brandList as $brand ): ?>
                        <tr>
                            ...
                            <td><img src="<?php echo e($brand->brand_logo); ?>"></td>

                            <td><?php echo e($brand->category_id); ?></td>
                            <?php if( $brand->is_hot == 0 ): ?>
                                <td>推荐</td>
                            <?php elseif( $brand->is_hot == 1 ): ?>
                                <td>不推荐</td>
                            <?php endif; ?>
                            <td><?php echo e($brand->sort); ?></td>
                            <td>
                                <div class="layui-btn-group">
                                    <a href="<?php echo e(url('admin/product/brand').'/'.$brand->id."/edit"); ?>"
                                       class="layui-btn  layui-btn-small" data-alt="修改品牌信息">
                                        <i class="larry-icon larry-xiugai"></i>编辑
                                    </a>
                                    <a id="delete" data-id="<?php echo e($brand->id); ?>" class="layui-btn  layui-btn-small" data-alt="删除">
    ...
    <script>
        layui.use(['jquery','layer'], function () {
            ...
            $('button#addbrand').on('click', function(){
                ...
                location.href='<?php echo e(url('/admin/product/brand/create')); ?>';
            });
            ...
            $('a#delete').on('click', function(){
                ...
                layer.confirm('确定要删除该品牌吗?', {
                    ...
                    $.ajax({
                        url:  "<?php echo e(url('/admin/product/brand')); ?>/" + id
                        , type: "POST"
