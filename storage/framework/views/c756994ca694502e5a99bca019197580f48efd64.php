                    ...
                    <div class="form-body">
                        <form class="layui-form" method="post" id="productDetail">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea type="text" name="summary" placeholder="请输入商品简介" autocomplete="off" class="layui-input"><?php echo e(isset($detail->summary) ? $detail->summary : ''); ?></textarea>
                                </div>
                            </div>
                            <!-- 活动提醒 -->
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea type="text" name="remind_title" placeholder="请输入位于商品简介前的活动提醒" autocomplete="off" class="layui-input"><?php echo e(isset($detail->remind_title) ? $detail->remind_title : ""); ?></textarea>
                                </div>
                            </div>
                            <!-- 商品分类 -->
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="is_free_shipping" value="0" <?php echo e($info->is_free_shipping == 0?"checked":''); ?> title="包邮">
                                    <input type="radio" name="is_free_shipping" value="1" <?php echo e($info->is_free_shipping == 1?"checked":''); ?> title="不包邮">
                                </div>
                            </div>
                            <!-- 是否推荐 -->
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="tags" lay-verify="required" placeholder="请输入商品关键字" autocomplete="off" class="layui-input" value="<?php echo e($info->tags); ?>">
                                </div>
                            </div>
                            <!-- 商品状态 -->
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                        <input id="upload-input" type="text" class="layui-input layui-input-inline" name="p_index_image" value="<?php echo e($info->p_index_image); ?>" style="width:520px;height:38px;margin:0px" placeholder="输入图片地址或点击上传">
                                    <div id="brand_logo">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <!-- 加载uefitor编辑器的容器 -->
                                    <script id="ueditor" name="description" type="text/plain"><?php echo e(isset( $detail->description )?$detail->description:''); ?></script>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <div class="layui-input-block">
