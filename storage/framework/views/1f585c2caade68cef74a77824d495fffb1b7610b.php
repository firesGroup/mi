...
<div class="span4">
    <div class="uc-box uc-sub-box">
        <div class="uc-nav-box">
            ...
            <div class="box-bd">
                <ul class="uc-nav-list">
                    <li><a href="" data-stat-id="8f3d1bffd166dc22">我的订单</a></li>
        ...
        <div class="uc-nav-box">
            ...
            <div class="box-bd">
                <ul class="uc-nav-list">
                    <li><a href="<?php echo e(url('user_detail')); ?>" data-stat-id="e171266eb8fa4af6">我的个人中心</a></li>
                    ...
                    <li><a href="">优惠券</a></li>
                    <li class="active"><a href="<?php echo e(url('member_address')); ?>" onclick="">收货地址</a></li>
                </ul>
            </div>
        </div>
        <div class="uc-nav-box">
