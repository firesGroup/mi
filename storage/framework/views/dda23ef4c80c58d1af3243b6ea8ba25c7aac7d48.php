        ...
        <div class=""
            ...
            <div style="text-align: center;width: 500px;height: 170px;float: left;margin-left: 40px;">
                <ul style="text-align: left;">
                    <li>订单ID: <span id="did"><?php echo e($data->id); ?></span></li>
                    <br>
                    <li>用户ID: <?php echo e($data->member_id); ?></li>
                    <br>
                </ul>
                <div style="float: left;">
                    <ul style="text-align:right;float: right;font-size: 20px;">
                        <li>订单编号: <?php echo e($data->order_sn); ?></li>
                        <br>
                    </ul>
                </div>
            </div>
            ...
            <div style="text-align: center;width: 500px;height:180px; float: left;margin-left: 40px;">
                <ul style="text-align: left;">
                    <li>订单总金额: <?php echo e($data->total); ?></li>
                    <br>
                    <li>订单创建时间: <?php echo e($data->add_time); ?></li>
                    <br>
                </ul>
                <div style="float: left;" id="div">

                    <ul style="text-align:right;float: right;" id="ul">
                        <li id="li"> 订单状态: <span id="p"><?php echo e($status[$data->order_status]); ?></span>
                            <?php if(!($status[$data->order_status]== '已完成') && !($status[$data->order_status] == '已取消') && !($status[$data->order_status] == '已作废')): ?>

                                <i class="layui-icon" style="font-size: 30px;">&#xe639;</i>
                            <?php endif; ?>
                            <span id="newid" style="display: none;"><?php echo e($data->order_status); ?></span>
                        </li>
            ...
            <div style="text-align: center;width: 500px;height: 180px;float: left;margin-left: 40px;">
                <ul style="text-align: left; font-size: 20px;">
                    <li>收货人: <?php echo e($data->buy_user); ?></li>
                    <br>
                    <li>收货人手机号: <?php echo e($data->buy_phone); ?></li>
                    <br>
                    <li>详细地址: <?php echo e($data->address); ?></li>
                </ul>
            </div>
                <div style="text-align: center;width: 500px;height: 150px;float: left;">
                    <ul style="text-align: left;">
                        <?php /*<li>配送方式: <?php echo e($data->delivery); ?></li>*/ ?>
                        <?php /*<br>*/ ?>
                        <?php /*<li>物流订单号: <?php echo e($data->delivery_orderid); ?></li>*/ ?>
                        <br>
                    </ul>
                </div>
            </div>
            ...
            <table class="layui-table" lay-skin="line" style="width:1100px;height:100px;background-color: #c2c2c2;">
                ...
                <?php /*<?php echo e(dd($orderdetail)); ?>*/ ?>

            <?php foreach($orderdetail as $v): ?>
                    <tr>
                    <td><?php echo e($v->p_id); ?></td>
                    <td><?php echo e($v->p_name); ?></td>
                    <td><?php echo e($v->p_price); ?></td>
                    <td><?php echo e($v->buy_num); ?></td>
...
//                    alert(sid);
                    ...
                    //定义路由
                    var url = '<?php echo e(url('/admin/orderStatus')); ?>';
