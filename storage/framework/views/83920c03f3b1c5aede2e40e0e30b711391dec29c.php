...
<?php $__env->startSection('title', '等级添加'); ?>
                ...
                <div class="layui-tab" lay-filter="tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" method="post" action="<?php echo e(url('admin/level')); ?>">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="level_name" lay-verify="required"
                                                   ...
                                                   id="level_name" value="<?php echo e(old('level_name')); ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="discount" lay-verify="required|discount|number" placeholder="请输入折扣率" id="discount"
                                                   autocomplete="off" class="layui-input" value="<?php echo e(old('discount')); ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <textarea type="text" name="level_desc" lay-verify="required"
                                                      ...
                                                      class="layui-input"><?php echo e(old('level_desc')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <div class="layui-input-block">
    ...
    <script>
        layui.use(['jquery', 'form', 'layer'], function () {
            ...
            $('#level_name').focusout(function () {
                ...
                if (origin != l_name) {
                    $.ajax({
                        url: '<?php echo e(url('admin/create_ajax')); ?>',
                        type: 'post',
