                ...
                <?php foreach($data as $k=>$v): ?>
                    <?php if($v->member_id != 2): ?>
                        ...
                        <td width="20%">
                            ...
                            <div style="display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;overflow: hidden;"><?php echo e($v->content); ?></div>
                        ...
                        <td>
                            <div class="layui-btn-group">
                                ...
                                <a href="<?php echo e(url('admin/comment').'/'.$v->member_id); ?>" class="layui-btn  layui-btn-small"
                                   data-alt="回复">
        ...
        layui.use(['jquery', 'layer'], function () {
            ...
            $('a#delete').on('click', function () {
                ...
                layer.confirm('确定要删除吗?', {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('/admin/comment')); ?>' + '/' + id
                        , type: "POST"
...
//
                ...
                var url = '<?php echo e(url('admin/commentStatus')); ?>';

                $.ajax({
                    url: url,
                    type: 'get',
                    data: {'cid': cid, 'id': nid,'token':'<?php echo e(csrf_token()); ?>'},//拼接发送要修改的显示的数值ID和评价表ID
