                    ...
                    <div class="order-summary">
                        ...
                        <div class="order-status">
                            ...
                            <span style="color: #ff6700;"><?php echo e($status[$orderid[0]->order_status]); ?></span>
                                <?php else: ?>
                                    <?php echo e($status[$orderid[0]->order_status]); ?>
                            ...
                            <td class="col col-name">
                                <p class="name">
                                    <a target="_blank" href="//item.mi.com/1160800072.html"
                                       ...
                                       onclick="_msq.push(['trackEvent', 'ba8c3443aa8bda14-cd966104ed488f46', '//item.mi.com/1160800072.html', 'pcpid', '']);"> <?php echo e($d->p_name); ?></a>
...
<?php endforeach; ?>
                ...
                <div id="editAddr" class="order-detail-info">
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            <th>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</th>
                            <td><?php echo e($orderid[0]->buy_user); ?></td>
                        </tr>
                        <tr>
                            <th>联系电话：</th>
                            <td><?php echo e(substr($orderid[0]->buy_phone,0,3).'*****'.substr($orderid[0]->buy_phone,8,3)); ?></td>
                        </tr>
                        <tr>
                            <th>收货地址：</th>
                            <td><?php echo e($orderid[0]->address); ?></td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="actions">
