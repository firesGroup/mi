...
<?php $__env->startSection('title','商品品牌管理-修改品牌'); ?>
    ...
    <section class="larry-grid">
        <div class="larry-personal">
            ...
            <div class="larry-personal-body clearfix">
                <div class="form-body">
                    <form class="layui-form" action="<?php echo e(url('admin/product/brand/')); ?>" method="post" id="brand">
                        <?php echo e(csrf_field()); ?>

                        <div class="layui-form-item">
                            <label class="layui-form-label">品牌名称</label>
                            <div class="layui-input-block">
                                <input type="text" name="brand_name" lay-verify="required" placeholder="请输入品牌名称" autocomplete="off" class="layui-input" value="<?php echo e(old('brand_name')); ?>">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">品牌网址</label>
                            <div class="layui-input-block">
                                <input type="text" name="brand_url" lay-verify="required" placeholder="请输入以 http 或 https 开头的网址" autocomplete="off" class="layui-input" value="<?php echo e(old('brand_url')); ?>">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input id="upload-input" type="text" class="layui-input layui-input-inline" name="brand_logo" value="<?php echo e(old('brand_logo')); ?>" style="width:520px;height:38px;margin:0px" placeholder="输入图片地址或点击上传">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea type="text" name="brand_desc" lay-verify="required" placeholder="请输入品牌描述" autocomplete="off" class="layui-input"><?php echo e(old('brand_desc')); ?></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                ...
                                <a class="layui-btn layui-btn-primary" href="<?php echo e(url('/admin/product/brand')); ?>">返回</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        layui.use( ['jquery','layer','form','upload'], function(){
            ...
            form.on('submit(addBrand)',function(data){
                ...
                $.ajax({
                    url: '<?php echo e(url('admin/product/brand/')); ?>',
                    type: 'POST',
                    data: data.field,
                        ...
                        if (res == 0) {
                            layer.msg('添加成功', {
                                icon: 6, time: 1000, end: function () {
                                    location.href = "<?php echo e(url('/admin/product/brand')); ?>";
                                }
                            });
                        } else {
                            layer.msg('添加失败', {
            ...
            layui.upload({
                ...
                before: function (input) {
                    //上传前回调
                    $('input#createUpload').parent().append('<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"><input type="hidden" name="path" value="brand">');
