                                ...
                                <form class="layui-form" action="<?php echo e(url('admin/slideShow/'.$data->id)); ?>" method="post">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input id="upload-input" type="text" class="layui-input layui-input-inline" name="images" value="<?php echo e($data->images); ?>" style="width:520px;height:38px;margin:0px" placeholder="输入图片地址或点击上传">
        ...
        layui.use( ['jquery','layer','form','upload'], function(){
            ...
            layui.upload({
                ...
                before: function (input) {
                    //上传前回调
                    $('input#createUpload').parent().append('<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"><input type="hidden" name="path" value="slideShow">');
