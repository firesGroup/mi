...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/css/admin/show.css')); ?>" media="all">
</head>
<body>
        ...
        layui.use(['jquery','layer','form', 'upload'], function () {
            ...
            layui.upload({
                ...
                before: function (input) {
                    //上传前回调
                    $('input#up').parent().append('<input type="hidden" name="_token" value="' + token + '"><input type="hidden" name="path" value="<?php echo e($path); ?>">');
                ...
                , success: function (res) {
                    if (res.status == 0) {
                        ...
                        layer.msg('上传成功',{
                            ...
                            $.ajax({
                                url: '<?php echo e(url($url)); ?>',// 写入数据库的url;
                                type: "post",
