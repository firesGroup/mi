 ...
 */
?>
<?php /*<?php echo e(dd(1111)); ?>*/ ?>


<?php $__env->startSection('title','管理员首页'); ?>
        ...
        <div class="larry-personal">
            ...
            <div class="larry-personal-body clearfix">
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(url('admin/user/create')); ?>" style="color:white">
                ...
                <table class="layui-table larry-table-info">
                    ...
                    <?php foreach( $data as $user ): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(($user->group_id > 0)?$group_name[$user->group_id]:'未分组'); ?></td>
                            <td style="color:#1E9FFF"><?php echo e($user->username); ?></td>
                            <td><?php echo e($user->password); ?></td>
                            <td><?php echo e($status[$user->status]); ?></td>
                            <td><?php echo e($user->add_time); ?></td>
                            <td><?php echo e($user->last_time); ?></td>
                            <td><?php echo e($user->last_ip); ?></td>
                            <td>
                                <div class="layui-btn-group">
                                    <a href="<?php echo e(url('admin/user').'/'.$user->id); ?>" class="layui-btn  layui-btn-small"
                                       data-alt="查看">
                                        <i class="layui-icon">&#xe60b;</i>
                                    </a>
                                    <a href="<?php echo e(url('admin/user').'/'.$user->id."/edit"); ?>"
                                       class="layui-btn  layui-btn-small" data-alt="修改">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a id="delete" data-id="<?php echo e($user->id); ?>" class="layui-btn  layui-btn-small"
                                       data-alt="删除">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                </div>
