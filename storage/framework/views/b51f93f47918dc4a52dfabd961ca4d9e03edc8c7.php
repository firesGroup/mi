                ...
                <div class="layui-tab" lay-filter="tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" method="post" action="<?php echo e(url('admin/advert')); ?>">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="ad_location" lay-verify="required"
                                                       ...
                                                       value="<?php echo e(old('ad_location_h')); ?>">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            ...
                                            <textarea type="text" name="ad_desc" lay-verify="required"
                                                      ...
                                                      class="layui-input"><?php echo e(old('avert_desc')); ?></textarea>
                                            </div>
                                        </div>
