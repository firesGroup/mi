                ...
                <div class="layui-tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" action="<?php echo e(url('admin/role')); ?>" method="POST">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="role_name" required lay-verify="required"
                                                   ...
                                                   class="layui-input" value="<?php echo e(old('role_name')); ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            ...
                                            <input type="text" name="role" required lay-verify="required"
                                                   placeholder="请输入方法" autocomplete="off" class="layui-input" value="<?php echo e(old('role')); ?>">
                                    ...
                                    <div class="layui-form-item layui-form-text">
                                        ...
                                        <div class="layui-input-block">
                                            <textarea name="role_desc" placeholder="请输入内容"
                                                      class="layui-textarea" value="<?php echo e(old('role_desc')); ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
