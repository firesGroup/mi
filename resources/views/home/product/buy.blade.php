        ...
        <div class="box clearfix">
            ...
            <div class="pro-choose-main container clearfix">
                    ...
                    <div id="J_img" class="img-con" style="left: 19.5px; margin-top: 0px;">
                        <div id="J_sliderView" class="sliderWrap" style="width: auto; position: relative;">
                            @foreach( $imgArr as $k=>$img )
                                @if($k == 0)
                                    <img data-url="{{ $img }}!560_560" class="loaded slider done" src="/images/public/placeholder-220.png">
                                @else
                                    <img data-url="{{ $img }}!560_560" class="slider done" src="/images/public/placeholder-220.png">
                                @endif
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="pro-info span10">
                    ...
                    <!-- 提示 -->
                    <p class="sale-desc" id="J_desc"><font color="#ff4a00">{{ $info->detail->remind_title or ''}}</font>{{$info->detail->summary or '' }}</p>
                    <!-- 选择第一级别 -->
...
//            console.log($('li.totleName').text());
            ...
            var ver_id = $('li.btn-biglarge').attr('data-ver_id');
            console.log(ver_id);
