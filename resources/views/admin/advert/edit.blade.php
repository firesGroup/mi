                ...
                <div class="layui-tab" lay-filter="tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show" style="padding-top:20px">
                            <div class="form-body">
                                <form class="layui-form" method="post" action="{{url('admin/advert/'.$data->id)}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">广告位置</label>
                                            <div class="layui-input-block">
                                                <input type="radio" name="status" value="0"  {{$data->status==0?'checked':''}} title="开启">
                                                <input type="radio" name="status" value="1" {{$data->status==1?'checked':''}} title="禁用">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <textarea type="text" name="ad_desc" lay-verify="required"
                                                      ...
                                                      class="layui-input">{{$data->ad_desc}}</textarea>
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="margin-left:15px">
                                            <label class="layui-form-label">上传广告图片</label>
                                            <input id="upload-input" type="text" class="layui-input layui-input-inline" name="advert_image" value="{{$data->advert_image}}" style="width:520px;height:38px;margin:0px" placeholder="输入图片地址或点击上传">
